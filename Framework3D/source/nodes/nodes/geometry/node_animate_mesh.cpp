...
{
    b.add_input<decl::String>("USD File Name").default_val("Default");
    b.add_input<decl::String>("Skel Path").default_val("skeleton");
    b.add_input<decl::String>("Mesh Path").default_val("geometry");
...
static void node_exec(ExeParams params)
{
    ...
    //auto animator = params.get_input<std::shared_ptr<Animator>>("");
